...
kiPress = micropython.const(8)

def taskUserFCN(taskName, period, zFlag, eulAng, gyrVel, calStat, duty1, duty2, KpShare, KdShare, KiShare, yShare, wFlag, dFlag):
    ...
    '''! @brief Creates the user interface.
         ...
         @param calStat A tuple containing mag, acc, gyr, and sys calib stats  
...
#    print('| 1. "z or Z": Reset Encoder 1 position to 0                |')
    print('| 2. "p or P": Print Euler Angles                           |')
