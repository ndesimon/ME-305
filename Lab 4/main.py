...
if __name__ == '__main__':
    ...
    #
    taskList = [UTask.taskUserFCN ('Task User', 10_000, zFlag, cFlag, eFlag, encData, duty1, duty2, KpShare, KiShare, yShare, wFlag),
                ETask.updateFunction ('Task Encoder', 10_000, zFlag, encData, ENC1, deltaTime, CLC),
                ...
                CTask.loopFunction('Task Closed Loop', 10_000, kFlag, CLC, encData, wFlag, KpShare, KiShare, yShare, duty1, deltaTime)]
