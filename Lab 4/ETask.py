...
def updateFunction(taskName, period, zFlag, encData, ENC1, deltaTime, CLC):
    '''! @brief Updates and zeros the encoder.
         ...
         @param ENC1 instantiates Encoder 1 in ETask.
         @param deltaTime A shared value containing the change in time between updates
                          of the encoder.
         @param CLC Instantiates the closed loop control class such that duty cycles can
                    can be obtained
    '''
