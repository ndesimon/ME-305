...
## @brief Creates Press variables used tor switching to a state in closed loop control after entering a key
#  @details Once the keys: m,M,t,y,k,ki,or r are pressed, the states are swtiched to each of 
#           the corresponding keys while within closed loop control.
#
