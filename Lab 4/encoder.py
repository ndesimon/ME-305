...
@details Creates an encoder class.  Interacts with encoder by creating a 16-bit
         counter which is used to determine the position, change in position, and
...
class Encoder:
    ...
    def get_vel(self):
        ...
        '''! @brief Method for obtaining velocity
             ...
             @return The angular velocity of the motor shaft
    ...
    def get_deltaTime(self):
        ...
        '''! @brief Method for obtaining change in time
             @details Retrieves the change of time computed in the update method.  
             @return The change in time between updates.  
